            ...
            <div class="participate">
                ...
                <div class="right-side">
                    <form action="#" class="form">
                        ...
                        <br />
                        <button type="button" class="input-file">VALITSE KUVA</button>
                        <input type="file" name="file" id="form-email" class="input-file-hidden" />

                        <p class="tas-link"><input type="checkbox" name="tas-check" class="tas-check" />Hyväksyn kilpailun <a href="#">säännöt ja ehdot</a></p>
                        <button type="submit" class="submit-btn">OSALLISTU</button>
                    </form>
                </div>
            </div>
